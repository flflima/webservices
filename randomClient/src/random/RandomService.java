 ...
 * 
 */
@WebServiceClient(name = "RandomService", targetNamespace = "http://random/", wsdlLocation = "http://localhost:8080/random?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RANDOMSERVICE_QNAME = new QName("http://random/", "RandomService");
    ...
    public Random getRandomPort() {
        return super.getPort(new QName("http://random/", "RandomPort"), Random.class);
    }
    ...
    public Random getRandomPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://random/", "RandomPort"), Random.class, features);
    }
