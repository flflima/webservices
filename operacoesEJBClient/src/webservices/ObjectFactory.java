...
public class ObjectFactory {
    ...
    private final static QName _Subtrair_QNAME = new QName("http://webservices/", "subtrair");
    private final static QName _SubtrairResponse_QNAME = new QName("http://webservices/", "subtrairResponse");
    private final static QName _Somar_QNAME = new QName("http://webservices/", "somar");
    ...
    private final static QName _SomarResponse_QNAME = new QName("http://webservices/", "somarResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "subtrair")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "subtrairResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "somar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "somarResponse")
